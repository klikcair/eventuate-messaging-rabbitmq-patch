...
public class MessageConsumerRabbitMQImpl implements CommonMessageConsumer {
	...
	private Logger logger = LoggerFactory.getLogger(getClass());
  	...
  	public MessageConsumerRabbitMQImpl(CoordinatorFactory coordinatorFactory,
  										EventuateRabbitMQCommonConfigurationProperties rabbitMqProperty,
  										int partitionCount) {
  	...
  	public MessageConsumerRabbitMQImpl(Supplier<String> subscriptionIdSupplier,
  		...
  		prepareRabbitMQConnection(rabbitMqProperty);
  	...
  	private void prepareRabbitMQConnection(EventuateRabbitMQCommonConfigurationProperties rabbitMqProperty) {
